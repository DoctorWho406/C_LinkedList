...
int main() {
    ...
    list_append(to_list & my_linked_list, to_node string_item_new("Test0012"));
    ...
    string_item_t *removed_item = list_remove(to_list & my_linked_list, to_node item_to_search, 8);
